...
func (x *ExecLoginResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *Confimation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Confimation) ProtoMessage() {}

func (x *Confimation) ProtoReflect() protoreflect.Message {
	mi := &file_execs_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Confimation.ProtoReflect.Descriptor instead.
func (*Confimation) Descriptor() ([]byte, []int) {
	return file_execs_proto_rawDescGZIP(), []int{4}
}

func (x *Confimation) GetConfirmation() bool {
	if x != nil {
		return x.Confirmation
	}
	return false
...
type ExecLogoutResponsesponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ExecLogoutResponsesponse) Reset() {
	*x = ExecLogoutResponsesponse{}
	mi := &file_execs_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExecLogoutResponsesponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecLogoutResponsesponse) ProtoMessage() {}

func (x *ExecLogoutResponsesponse) ProtoReflect() protoreflect.Message {
	mi := &file_execs_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecLogoutResponsesponse.ProtoReflect.Descriptor instead.
func (*ExecLogoutResponsesponse) Descriptor() ([]byte, []int) {
	return file_execs_proto_rawDescGZIP(), []int{9}
}

func (x *ExecLogoutResponsesponse) GetLoggedOut() bool {
	if x != nil {
		return x.LoggedOut
	}
	return false
...
type Exec struct {
	...
	PasswordChangedAt    string                 `protobuf:"bytes,8,opt,name=password_changed_at,json=passwordChangedAt,proto3" json:"password_changed_at,omitempty"`
	UserCreatedAt        string                 `protobuf:"bytes,9,opt,name=user_created_at,json=userCreatedAt,proto3" json:"user_created_at,omitempty"`
...
const file_execs_proto_rawDesc = "" +
	...
	"\fEmptyRequest\"9\n" +
	"\x18ExecLogoutResponsesponse\x12\x1d\n" +
	"\n" +
	"logged_out\x18\x01 \x01(\bR\tloggedOut\"R\n" +
	...
	"\x13password_changed_at\x18\b \x01(\tR\x11passwordChangedAt\x12&\n" +
	"\x0fuser_created_at\x18\t \x01(\tR\ruserCreatedAt\x120\n" +
	"\x14password_reset_token\x18\n" +
	" \x01(\tR\x12passwordResetToken\x124\n" +
	"\x16password_token_expires\x18\v \x01(\tR\x14passwordTokenExpires\x12'\n" +
	"\x0finactive_status\x18\f \x01(\bR\x0einactiveStatus\")\n" +
	"\x05Execs\x12 \n" +
	"\x05execs\x18\x01 \x03(\v2\n" +
	".main.ExecR\x05execs2\xcf\x04\n" +
	"\vExecService\x12.\n" +
	...
	"\x05Login\x12\x16.main.ExecLoginRequest\x1a\x17.main.ExecLoginResponse\x12<\n" +
	"\x06Logout\x12\x12.main.EmptyRequest\x1a\x1e.main.ExecLogoutResponsesponse\x12K\n" +
	"\x0eUpdatePassword\x12\x1b.main.UpdatePasswordRequest\x1a\x1c.main.UpdatePasswordResponse\x12>\n" +
	"\rResetPassword\x12\x1a.main.ResetPasswordRequest\x1a\x11.main.Confimation\x12K\n" +
	"\x0eForgotPassword\x12\x1b.main.ForgotPasswordRequest\x1a\x1c.main.ForgotPasswordResponse\x122\n" +
	"\x0eDeactivateUser\x12\r.main.ExecIds\x1a\x11.main.ConfimationB\x16Z\x14/proto/gen;grpcapipbb\x06proto3"
...
var file_execs_proto_goTypes = []any{
	...
	(*Confimation)(nil),              // 4: main.Confimation
	...
	(*ExecLogoutResponsesponse)(nil), // 9: main.ExecLogoutResponsesponse
...
var file_execs_proto_depIdxs = []int32{
	...
	15, // 5: main.ExecService.AddExecs:input_type -> main.Execs
	15, // 6: main.ExecService.UpdateExecs:input_type -> main.Execs
	12, // 7: main.ExecService.DeleteExecs:input_type -> main.ExecIds
	0,  // 8: main.ExecService.Login:input_type -> main.ExecLoginRequest
	8,  // 9: main.ExecService.Logout:input_type -> main.EmptyRequest
	7,  // 10: main.ExecService.UpdatePassword:input_type -> main.UpdatePasswordRequest
	5,  // 11: main.ExecService.ResetPassword:input_type -> main.ResetPasswordRequest
	3,  // 12: main.ExecService.ForgotPassword:input_type -> main.ForgotPasswordRequest
	12, // 13: main.ExecService.DeactivateUser:input_type -> main.ExecIds
	...
	10, // 17: main.ExecService.DeleteExecs:output_type -> main.DeleteExecsConfirmation
	1,  // 18: main.ExecService.Login:output_type -> main.ExecLoginResponse
	9,  // 19: main.ExecService.Logout:output_type -> main.ExecLogoutResponsesponse
	6,  // 20: main.ExecService.UpdatePassword:output_type -> main.UpdatePasswordResponse
	4,  // 21: main.ExecService.ResetPassword:output_type -> main.Confimation
	2,  // 22: main.ExecService.ForgotPassword:output_type -> main.ForgotPasswordResponse
	4,  // 23: main.ExecService.DeactivateUser:output_type -> main.Confimation
