...
func (c *teacherServiceClient) GetTeachers(ctx context.Context, in *GetTeachersRequest, opts ...grpc.CallOption) (*Teachers, error) {
...
func (UnimplementedTeacherServiceServer) GetTeachers(context.Context, *GetTeachersRequest) (*Teachers, error) {
