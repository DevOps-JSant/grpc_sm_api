...
const file_students_proto_rawDesc = "" +
	"\n" +
	"\x0estudents.proto\x12\x04main\x1a\x17validate/validate.proto\"U\n" +
	...
	"\x05order\x18\x02 \x01(\x0e2\v.main.OrderR\x05order\"\xcf\x01\n" +
	"\aStudent\x12\x0e\n" +
	...
	"\x05class\x18\x05 \x01(\tB\x15\xfaB\x12r\x10\x10\x012\f^[1-9][A-Z]$R\x05class\"5\n" +
	"\bStudents\x12)\n" +
...
var file_students_proto_depIdxs = []int32{
	...
	4, // 5: main.StudentService.GetStudents:input_type -> main.GetStudentsRequest
	7, // 6: main.StudentService.AddStudents:input_type -> main.Students
	7, // 7: main.StudentService.UpdateStudents:input_type -> main.Students
	3, // 8: main.StudentService.DeleteStudents:input_type -> main.StudentIds
	7, // 9: main.StudentService.GetStudents:output_type -> main.Students
	7, // 10: main.StudentService.AddStudents:output_type -> main.Students
	7, // 11: main.StudentService.UpdateStudents:output_type -> main.Students
	1, // 12: main.StudentService.DeleteStudents:output_type -> main.DeleteStudentsConfirmation
